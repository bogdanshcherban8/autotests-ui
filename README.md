...
the [UI Test Application](https://nikita-filonov.github.io/qa-automation-engineer-ui-course/#/auth/login). The
...
```bash
git clone https://github.com/bogdanshcherban8/autotests-ui.git
cd autotests-ui
```
