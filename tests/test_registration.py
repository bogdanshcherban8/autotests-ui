...
def test_successful_registration(registration_page: RegistrationPage, user_form: dict):
    ...
    registration_page.reg_fill(user_form['email'], user_form['username'], user_form['password'])
